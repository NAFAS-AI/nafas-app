...
(function() {
  ...
  var streakMessages = [
    ...
    'سلسلة {n} أيام 💪 تبني عادة رائعة!',
    '{n} أيام! 🌟 هذا اللي يسمّونه التزام حقيقي',
    'يوم {n} معنا 🌿 وكل يوم تتحسن أكثر'
  ];
