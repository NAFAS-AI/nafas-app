...
(function() {
  ...
  var morningGreetings = [
    'صباح النور ☀️ يوم جديد… فرصة جديدة تتنفسين فيها',
    'صباحكِ دفء 🌤️ خذي لحظة هدوء قبل ما يبدأ اليوم',
    'صباح الخير 🌅 الصبح يبدأ من نَفَس هادئ',
    'أهلاً بالنور ☀️ جسمك يستاهل يبدأ يومه بسكينة',
    'صباحكِ سلام 🕊️ قبل أي شي… تنفّسي',
  ...
  var afternoonGreetings = [
    ...
    'نص اليوم ⏳ وقت مناسب تاخذين نَفَس عميق',
    'هلا فيك 💛 إذا اليوم كان طويل — هنا مكان تستريحين فيه',
    'مرحباً 🌿 تحتاجين وقفة بسيطة؟ أنا هنا',
    'يا هلا 🧡 أحياناً نص اليوم هو أكثر وقت نحتاج فيه لحظة',
    'أهلاً فيك 💛 خذي دقيقة — الباقي يقدر ينتظر',
    'الحين وقت حلو تسمعين نفسك 🎧'
  ];

  var eveningGreetings = [
    'مساء السكينة 🌙 اليوم وشك يخلص — كيف تحسين؟',
    'مساء الخير 🌆 خذي لحظة تراجعين فيها يومك بهدوء',
  ...
  var nightGreetings = [
    ...
    'الليل عميق… مثل نَفَس حقيقي 🌙 خذي وقتك',
    'هلا فيك 🌙 ما تحتاجين سبب عشان تفضفضين',
  ...
  var returningMessages = [
    ...
    'حياكِ 💛 كل مرة ترجعين فيها = خطوة حلوة'
  ];

  var streakMessages = [
    'يوم {n} على التوالي 🔥 ما شاء الله عليكِ!',
