...
function injectCSS(){
  ...
  s.textContent='\
.nft-card{position:fixed;bottom:0;left:0;right:0;z-index:99998;\
background:linear-gradient(170deg,rgba(15,30,40,0.99),rgba(10,22,30,0.99));\
backdrop-filter:blur(24px);-webkit-backdrop-filter:blur(24px);\
border:none;border-top:1px solid rgba(94,204,199,0.2);border-radius:24px 24px 0 0;\
padding:32px 24px 36px;text-align:center;font-family:Tajawal,sans-serif;\
box-shadow:0 -16px 64px rgba(0,0,0,0.5);width:100%;max-width:100%;\
animation:nftSlide 0.5s cubic-bezier(0.16,1,0.3,1);direction:rtl}\
@keyframes nftSlide{from{opacity:0;transform:translateY(100%)}to{opacity:1;transform:translateY(0)}}\
.nft-card h3{color:#5ECCC7;font-size:1.15em;margin:0 0 6px;font-weight:700}\
.nft-card .nft-sub{color:rgba(255,255,255,0.45);font-size:0.82em;margin-bottom:20px}\
.nft-emojis{display:flex;justify-content:center;gap:12px;margin:12px 0 18px}\
.nft-emojis button{background:rgba(94,204,199,0.06);border:2px solid rgba(94,204,199,0.12);\
border-radius:50%;padding:0;font-size:1.8em;cursor:pointer;\
transition:all 0.25s cubic-bezier(0.16,1,0.3,1);width:54px;height:54px;\
display:flex;align-items:center;justify-content:center}\
.nft-emojis button:hover{background:rgba(94,204,199,0.12);border-color:rgba(94,204,199,0.35);transform:scale(1.18)}\
.nft-emojis button.sel{background:rgba(94,204,199,0.18);border-color:#5ECCC7;transform:scale(1.2);box-shadow:0 0 20px rgba(94,204,199,0.25)}\
.nft-skip{background:none;border:none;color:rgba(255,255,255,0.3);font-size:0.78em;\
cursor:pointer;margin-top:10px;font-family:inherit;padding:8px 16px}\
...
function closeCard(card){
  card.style.animation='nftSlide 0.3s ease reverse';card.style.transform='translateY(100%)';
